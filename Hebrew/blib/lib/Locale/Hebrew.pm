...
I can't recall where I snipped this code from. It is severely incomplete -
adds extra spaces and can't take care of inverted paranthesis.

=head1 TODO

Write a reasonable routine myself. Optionally in Perl.
